...
import { Calendar, ColorMapping, ColorPicker, Customers, Ecommerce, Editor, Employees, Kanban, Orders, Area, Bar, Pie, Financial, Pyramid, Stacked, Line } from './pages'
			...
			<BrowserRouter>
				<div className='flex relative dark:bg-main-dark-bg'>
					<div className='fixed right-4 bottom-4' style={{ zIndex: '100' }}>
						<TooltipComponent className='' content="Settings" position='Top'>
