						...
						<>
							<div className='flex justify-between items-cente'>
                                    ...
                                    <TooltipComponent position='BottomCenter' content="Menu">
                                        <button type='button' onClick={()=>setActiveMenu((prevActiveMenu)=>!prevActiveMenu)} className="text-xl rounded-full p-3 mt-4 block hover:bg-light-gray">
                                            <MdOutlineCancel/>
                                        </button>
                                    </TooltipComponent>
							</div>
                            ...
                            {links.map((item)=>(
                                    <div key={item.title}>
                                        <p className='uppercase m-3 mt-4 text-gray-900 dark:text-gray-100'>
                                            {item.title}
                                        </p>
                                    {item.links.map((link)=>(
                                            <NavLink
